  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0">
        ...
        <div className="flex flex-row gap-2 w-full justify-between items-center px-4 py-4">
          <img src={Left} alt="left" onClick={handleClose} />
          <span className="text-[18px] leading-[28px] font-[600] text-white ml-10">
            My Wallet
          </span>
          <button
            className="p-2 text-white font-[500] text-[12px] leading-[18px] bg-[#20202A] rounded-[8px] px-4 py-2"
      ...
      >
        <div className="flex flex-col gap-1 px-4 py-4 items-center justify-center bg-[#FFFFFF1A] mx-4 rounded-[16px] mb-4">
